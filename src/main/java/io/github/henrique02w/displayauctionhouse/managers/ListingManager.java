    ...
    public void loadListings() {
        ...
        for (String id : section.getKeys(false)) {
            try {
                ...
                if (sellerUUIDStr == null || itemData == null) {
                    loadFailed = true;
                    continue;
                }
                ...
                if (item == null) {
                    loadFailed = true;
                    plugin.getLogger().warning("O item da listing " + id + " não pôde ser lido; a listing foi ignorada.");
                    continue;
                }
        ...
        if (loadFailed) FileBackup.create(plugin, listingsFile);
    ...
    public synchronized boolean purchaseListing(Player buyer, String listingId) {
        ...
        try {
            ...
            if (!plugin.getEconomyManager().available()) {
                buyer.sendMessage(ColorUtils.color(prefix +
